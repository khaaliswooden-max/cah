...
# Configuration - Points to repository root
BASE_DIR = Path(__file__).parent.parent.parent.resolve()  # repo root
SCRIPTS_DIR = Path(__file__).parent.resolve()  # Scripts are in this directory
REPORTS_DIR = BASE_DIR / "reports" / "acquisition"
